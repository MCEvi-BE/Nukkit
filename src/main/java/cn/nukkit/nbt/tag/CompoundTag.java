...
public class CompoundTag extends Tag implements Cloneable {
    ...
    public Optional<Integer> getByteOptional(final String name) {
        if (!this.tags.containsKey(name)) {
            return Optional.empty();
        }
        return Optional.of(
            ((NumberTag) this.tags.get(name)).getData().intValue());
    }
    ...
    public Optional<Integer> getIntOptional(final String name) {
        if (!this.tags.containsKey(name)) {
            return Optional.empty();
        }
    ...
    public Map<String, Tag> values() {
        final Map<String, Tag> value = new HashMap<>(this.tags.size());
