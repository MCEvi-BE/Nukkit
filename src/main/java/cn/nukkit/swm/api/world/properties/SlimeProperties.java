...
public class SlimeProperties {
    ...
    public static final SlimeProperty ALLOW_MOBS = new SlimeProperty("doMobSpawning", PropertyType.BOOLEAN, true);
    ...
    public static final SlimeProperty[] VALUES = {SlimeProperties.SPAWN_X, SlimeProperties.SPAWN_Y, SlimeProperties.SPAWN_Z, SlimeProperties.DIFFICULTY, SlimeProperties.ALLOW_MONSTERS, SlimeProperties.ALLOW_ANIMALS, SlimeProperties.PVP, SlimeProperties.ENVIRONMENT, SlimeProperties.WORLD_TYPE};
